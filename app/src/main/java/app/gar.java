...
public class gar extends Activity {
    ...
    private class DownloadJSON extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog = ProgressDialog.show(gar.this, null, null, true);
        ...
        protected Void doInBackground(Void... params) {
            ...
            jsonobject = JSONfunctions
                    .getJSONfromURL("http://api.recrm.ru/json/estate/search?key=3e6d2ce2a14a41f99101cd3e5b74a214&4&group_id=13&start=0&count=2000");
        ...
        protected void onPostExecute(Void args) {
            ...
            adapter = new ListViewAdapter(gar.this, arraylist);
